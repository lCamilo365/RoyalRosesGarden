...
public class Product_Info extends AppCompatActivity {
    ...
    private Button btnProductBack, btnProductLocationInfo;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Product product = new Product(
                ...
                Double.parseDouble(intentIn.getStringExtra("price")),
                intentIn.getStringExtra("image"),
                Double.parseDouble(intentIn.getStringExtra("latitude")),
                Double.parseDouble(intentIn.getStringExtra("longitude"))
        );
...
*/
        ...
        btnProductLocationInfo.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
